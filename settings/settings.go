...
func NewSettings(alternativeContext ...string) *Settings {
	...
	return &Settings{
		...
		UtxoStore: UtxoStoreSettings{
			...
			PostgresDAHSweepMode:                    getString("utxostore_postgresDAHSweepMode", "go", alternativeContext...),
			PostgresDAHSweepBatchRows:               getInt("utxostore_postgresDAHSweepBatchRows", 5000, alternativeContext...),
			PostgresDAHSweepMaxWindowsPerCall:       getInt("utxostore_postgresDAHSweepMaxWindowsPerCall", 32, alternativeContext...),
			PostgresDAHSweepIdleIntervalMillis:      getInt("utxostore_postgresDAHSweepIdleIntervalMillis", 5000, alternativeContext...),
			PostgresDAHSweepContendedBackoffMillis:  getInt("utxostore_postgresDAHSweepContendedBackoffMillis", 0, alternativeContext...),
			PostgresDAHSweepCallTimeoutMultiple:     getInt("utxostore_postgresDAHSweepCallTimeoutMultiple", 50, alternativeContext...),
