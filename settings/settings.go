...
func NewSettings(alternativeContext ...string) *Settings {
	...
	return &Settings{
		...
		Legacy: LegacySettings{
			...
			ForceQuickValidation:                   getBool("legacy_forceQuickValidation", false, alternativeContext...),
			QuickValidationCatchupInCatchingBlocks: getBool("legacy_quickValidationInCatchingBlocks", true, alternativeContext...),
			...
			SubtreeWriteBatchBlocks:                getInt("legacy_subtreeWriteBatchBlocks", 1, alternativeContext...),
			SubtreeWriteBatchWait:                  getDuration("legacy_subtreeWriteBatchWait", 500*time.Millisecond, alternativeContext...),
		},
