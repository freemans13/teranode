...
func NewSettings(alternativeContext ...string) *Settings {
	...
	return &Settings{
		...
		Pruner: PrunerSettings{
			...
			UTXOPrunedSetMaxEntries:        getInt("pruner_utxoPrunedSetMaxEntries", 10_000_000, alternativeContext...),          // Deprecated: the pruned-TX filter is disabled; retained for configuration compatibility
		},
