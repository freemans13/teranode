...
type Store interface {
	...
	// be missing — breaking subsequent blocks that spend them.
	//
	// The context bounds the drain. Implementations should respect it and
	// return its error if the drain cannot complete in time.
