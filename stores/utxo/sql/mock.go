...
func SetupCreatePostgresSchemaErrorMocks(mockDB *MockDB, errorAtStep int) {
	...
	stepMatchers := []func(string) bool{
		...
		func(q string) bool { return strings.Contains(q, "CREATE TABLE IF NOT EXISTS conflict_intents") },
		func(q string) bool { return strings.Contains(q, "CREATE TABLE IF NOT EXISTS deleted_children") },
	}
