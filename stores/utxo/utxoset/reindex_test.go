...
func TestUTXOIndexRebuildDecision(t *testing.T) {
	require.False(t, utxoIndexNeedsRebuild(31_500_000, 1_000_000))
	require.False(t, utxoIndexNeedsRebuild(50_000_000, 1_000_000))
	require.True(t, utxoIndexNeedsRebuild(60_000_000, 1_000_000))
	require.False(t, utxoIndexNeedsRebuild(60_000_000, 0), "no rows, nothing to judge")
}
