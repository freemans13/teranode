...
type BlockchainAPIClient interface {
	...
	GetBlockHeadersByParentLinks(ctx context.Context, in *GetBlockHeadersRequest, opts ...grpc.CallOption) (*GetBlockHeadersResponse, error)
...
func (c *blockchainAPIClient) GetBlockHeadersByParentLinks(ctx context.Context, in *GetBlockHeadersRequest, opts ...grpc.CallOption) (*GetBlockHeadersResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetBlockHeadersResponse)
	err := c.cc.Invoke(ctx, BlockchainAPI_GetBlockHeadersByParentLinks_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BlockchainAPIServer interface {
	...
	// It never selects rows by the on_main_chain flag and never reads or writes a cache, so it
	// is the fetch a chain answer is proven against.
	GetBlockHeadersByParentLinks(context.Context, *GetBlockHeadersRequest) (*GetBlockHeadersResponse, error)
	// GetBlockHeadersToCommonAncestor retrieves headers from a block to its common ancestor.
...
func _BlockchainAPI_GetBlockHeadersByParentLinks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetBlockHeadersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BlockchainAPIServer).GetBlockHeadersByParentLinks(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BlockchainAPI_GetBlockHeadersByParentLinks_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BlockchainAPIServer).GetBlockHeadersByParentLinks(ctx, req.(*GetBlockHeadersRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BlockchainAPI_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _BlockchainAPI_GetBlockHeadersByParentLinks_Handler,
		},
		{
