...
var file_services_blockchain_blockchain_api_blockchain_api_proto_msgTypes = make([]protoimpl.MessageInfo, 73)
var file_services_blockchain_blockchain_api_blockchain_api_proto_goTypes = []any{
	...
	nil,                                                 // 74: blockchain_api.NotificationMetadata.MetadataEntry
	(*timestamppb.Timestamp)(nil),                       // 75: google.protobuf.Timestamp
	(model.NotificationType)(0),                         // 76: model.NotificationType
	(*model.BlockInfo)(nil),                             // 77: model.BlockInfo
	(*model.SuitableBlock)(nil),                         // 78: model.SuitableBlock
	(*model.ChainTip)(nil),                              // 79: model.ChainTip
	(*emptypb.Empty)(nil),                               // 80: google.protobuf.Empty
	(*model.BlockStats)(nil),                            // 81: model.BlockStats
	(*model.BlockDataPoints)(nil),                       // 82: model.BlockDataPoints
}
var file_services_blockchain_blockchain_api_blockchain_api_proto_depIdxs = []int32{
	75, // 0: blockchain_api.HealthResponse.timestamp:type_name -> google.protobuf.Timestamp
	75, // 1: blockchain_api.GetBlockHeaderResponse.processed_at:type_name -> google.protobuf.Timestamp
	76, // 2: blockchain_api.Notification.type:type_name -> model.NotificationType
	40, // 3: blockchain_api.Notification.metadata:type_name -> blockchain_api.NotificationMetadata
	74, // 4: blockchain_api.NotificationMetadata.metadata:type_name -> blockchain_api.NotificationMetadata.MetadataEntry
	77, // 5: blockchain_api.GetLastNBlocksResponse.blocks:type_name -> model.BlockInfo
	77, // 6: blockchain_api.GetLastNInvalidBlocksResponse.blocks:type_name -> model.BlockInfo
	78, // 7: blockchain_api.GetSuitableBlockResponse.block:type_name -> model.SuitableBlock
	...
	79, // 11: blockchain_api.GetChainTipsResponse.tips:type_name -> model.ChainTip
	80, // 12: blockchain_api.BlockchainAPI.HealthGRPC:input_type -> google.protobuf.Empty
	...
	80, // 18: blockchain_api.BlockchainAPI.GetNextBlockID:input_type -> google.protobuf.Empty
	80, // 19: blockchain_api.BlockchainAPI.GetBlockStats:input_type -> google.protobuf.Empty
	...
	80, // 38: blockchain_api.BlockchainAPI.GetBestBlockHeader:input_type -> google.protobuf.Empty
	32, // 39: blockchain_api.BlockchainAPI.CheckBlockIsInCurrentChain:input_type -> blockchain_api.CheckBlockIsCurrentChainRequest
	80, // 40: blockchain_api.BlockchainAPI.GetChainTips:input_type -> google.protobuf.Empty
	...
	80, // 51: blockchain_api.BlockchainAPI.GetBlocksMinedNotSet:input_type -> google.protobuf.Empty
	61, // 52: blockchain_api.BlockchainAPI.SetBlockSubtreesSet:input_type -> blockchain_api.SetBlockSubtreesSetRequest
	80, // 53: blockchain_api.BlockchainAPI.GetBlocksSubtreesNotSet:input_type -> google.protobuf.Empty
	63, // 54: blockchain_api.BlockchainAPI.SetBlockProcessedAt:input_type -> blockchain_api.SetBlockProcessedAtRequest
	66, // 55: blockchain_api.BlockchainAPI.SendFSMEvent:input_type -> blockchain_api.SendFSMEventRequest
	80, // 56: blockchain_api.BlockchainAPI.GetFSMCurrentState:input_type -> google.protobuf.Empty
	65, // 57: blockchain_api.BlockchainAPI.WaitFSMToTransitionToGivenState:input_type -> blockchain_api.WaitFSMToTransitionRequest
	80, // 58: blockchain_api.BlockchainAPI.WaitUntilFSMTransitionFromIdleState:input_type -> google.protobuf.Empty
	80, // 59: blockchain_api.BlockchainAPI.Run:input_type -> google.protobuf.Empty
	80, // 60: blockchain_api.BlockchainAPI.CatchUpBlocks:input_type -> google.protobuf.Empty
	80, // 61: blockchain_api.BlockchainAPI.LegacySync:input_type -> google.protobuf.Empty
	80, // 62: blockchain_api.BlockchainAPI.Idle:input_type -> google.protobuf.Empty
	73, // 63: blockchain_api.BlockchainAPI.ReportPeerFailure:input_type -> blockchain_api.ReportPeerFailureRequest
	67, // 64: blockchain_api.BlockchainAPI.GetBlockLocator:input_type -> blockchain_api.GetBlockLocatorRequest
	69, // 65: blockchain_api.BlockchainAPI.LocateBlockHeaders:input_type -> blockchain_api.LocateBlockHeadersRequest
	80, // 66: blockchain_api.BlockchainAPI.GetBestHeightAndTime:input_type -> google.protobuf.Empty
	2,  // 67: blockchain_api.BlockchainAPI.HealthGRPC:output_type -> blockchain_api.HealthResponse
	80, // 68: blockchain_api.BlockchainAPI.AddBlock:output_type -> google.protobuf.Empty
	11, // 69: blockchain_api.BlockchainAPI.GetBlock:output_type -> blockchain_api.GetBlockResponse
	6,  // 70: blockchain_api.BlockchainAPI.GetBlocks:output_type -> blockchain_api.GetBlocksResponse
	11, // 71: blockchain_api.BlockchainAPI.GetBlockByHeight:output_type -> blockchain_api.GetBlockResponse
	11, // 72: blockchain_api.BlockchainAPI.GetBlockByID:output_type -> blockchain_api.GetBlockResponse
	9,  // 73: blockchain_api.BlockchainAPI.GetNextBlockID:output_type -> blockchain_api.GetNextBlockIDResponse
	81, // 74: blockchain_api.BlockchainAPI.GetBlockStats:output_type -> model.BlockStats
	82, // 75: blockchain_api.BlockchainAPI.GetBlockGraphData:output_type -> model.BlockDataPoints
	47, // 76: blockchain_api.BlockchainAPI.GetLastNBlocks:output_type -> blockchain_api.GetLastNBlocksResponse
	49, // 77: blockchain_api.BlockchainAPI.GetLastNInvalidBlocks:output_type -> blockchain_api.GetLastNInvalidBlocksResponse
	51, // 78: blockchain_api.BlockchainAPI.GetSuitableBlock:output_type -> blockchain_api.GetSuitableBlockResponse
	55, // 79: blockchain_api.BlockchainAPI.GetHashOfAncestorBlock:output_type -> blockchain_api.GetHashOfAncestorBlockResponse
	36, // 80: blockchain_api.BlockchainAPI.GetLatestBlockHeaderFromBlockLocator:output_type -> blockchain_api.GetBlockHeaderResponse
	19, // 81: blockchain_api.BlockchainAPI.GetBlockHeadersFromOldest:output_type -> blockchain_api.GetBlockHeadersResponse
	57, // 82: blockchain_api.BlockchainAPI.GetNextWorkRequired:output_type -> blockchain_api.GetNextWorkRequiredResponse
	14, // 83: blockchain_api.BlockchainAPI.GetBlockExists:output_type -> blockchain_api.GetBlockExistsResponse
	19, // 84: blockchain_api.BlockchainAPI.GetBlockHeaders:output_type -> blockchain_api.GetBlockHeadersResponse
	19, // 85: blockchain_api.BlockchainAPI.GetBlockHeadersToCommonAncestor:output_type -> blockchain_api.GetBlockHeadersResponse
	19, // 86: blockchain_api.BlockchainAPI.GetBlockHeadersFromCommonAncestor:output_type -> blockchain_api.GetBlockHeadersResponse
	19, // 87: blockchain_api.BlockchainAPI.GetBlockHeadersFromTill:output_type -> blockchain_api.GetBlockHeadersResponse
	22, // 88: blockchain_api.BlockchainAPI.GetBlockHeadersFromHeight:output_type -> blockchain_api.GetBlockHeadersFromHeightResponse
	24, // 89: blockchain_api.BlockchainAPI.GetBlockHeadersByHeight:output_type -> blockchain_api.GetBlockHeadersByHeightResponse
	26, // 90: blockchain_api.BlockchainAPI.GetBlocksByHeight:output_type -> blockchain_api.GetBlocksByHeightResponse
	28, // 91: blockchain_api.BlockchainAPI.FindBlocksContainingSubtree:output_type -> blockchain_api.FindBlocksContainingSubtreeResponse
	29, // 92: blockchain_api.BlockchainAPI.GetBlockHeaderIDs:output_type -> blockchain_api.GetBlockHeaderIDsResponse
	36, // 93: blockchain_api.BlockchainAPI.GetBestBlockHeader:output_type -> blockchain_api.GetBlockHeaderResponse
	37, // 94: blockchain_api.BlockchainAPI.CheckBlockIsInCurrentChain:output_type -> blockchain_api.CheckBlockIsCurrentChainResponse
	72, // 95: blockchain_api.BlockchainAPI.GetChainTips:output_type -> blockchain_api.GetChainTipsResponse
	36, // 96: blockchain_api.BlockchainAPI.GetBlockHeader:output_type -> blockchain_api.GetBlockHeaderResponse
	34, // 97: blockchain_api.BlockchainAPI.InvalidateBlock:output_type -> blockchain_api.InvalidateBlockResponse
	80, // 98: blockchain_api.BlockchainAPI.RevalidateBlock:output_type -> google.protobuf.Empty
	39, // 99: blockchain_api.BlockchainAPI.Subscribe:output_type -> blockchain_api.Notification
	80, // 100: blockchain_api.BlockchainAPI.SendNotification:output_type -> google.protobuf.Empty
	42, // 101: blockchain_api.BlockchainAPI.GetState:output_type -> blockchain_api.StateResponse
	80, // 102: blockchain_api.BlockchainAPI.SetState:output_type -> google.protobuf.Empty
	45, // 103: blockchain_api.BlockchainAPI.GetBlockIsMined:output_type -> blockchain_api.GetBlockIsMinedResponse
	80, // 104: blockchain_api.BlockchainAPI.SetBlockMinedSet:output_type -> google.protobuf.Empty
	80, // 105: blockchain_api.BlockchainAPI.ClearBlockMinedSet:output_type -> google.protobuf.Empty
	60, // 106: blockchain_api.BlockchainAPI.GetBlocksMinedNotSet:output_type -> blockchain_api.GetBlocksMinedNotSetResponse
	80, // 107: blockchain_api.BlockchainAPI.SetBlockSubtreesSet:output_type -> google.protobuf.Empty
	62, // 108: blockchain_api.BlockchainAPI.GetBlocksSubtreesNotSet:output_type -> blockchain_api.GetBlocksSubtreesNotSetResponse
	80, // 109: blockchain_api.BlockchainAPI.SetBlockProcessedAt:output_type -> google.protobuf.Empty
	64, // 110: blockchain_api.BlockchainAPI.SendFSMEvent:output_type -> blockchain_api.GetFSMStateResponse
	64, // 111: blockchain_api.BlockchainAPI.GetFSMCurrentState:output_type -> blockchain_api.GetFSMStateResponse
	80, // 112: blockchain_api.BlockchainAPI.WaitFSMToTransitionToGivenState:output_type -> google.protobuf.Empty
	80, // 113: blockchain_api.BlockchainAPI.WaitUntilFSMTransitionFromIdleState:output_type -> google.protobuf.Empty
	80, // 114: blockchain_api.BlockchainAPI.Run:output_type -> google.protobuf.Empty
	80, // 115: blockchain_api.BlockchainAPI.CatchUpBlocks:output_type -> google.protobuf.Empty
	80, // 116: blockchain_api.BlockchainAPI.LegacySync:output_type -> google.protobuf.Empty
	80, // 117: blockchain_api.BlockchainAPI.Idle:output_type -> google.protobuf.Empty
	80, // 118: blockchain_api.BlockchainAPI.ReportPeerFailure:output_type -> google.protobuf.Empty
	68, // 119: blockchain_api.BlockchainAPI.GetBlockLocator:output_type -> blockchain_api.GetBlockLocatorResponse
	70, // 120: blockchain_api.BlockchainAPI.LocateBlockHeaders:output_type -> blockchain_api.LocateBlockHeadersResponse
	71, // 121: blockchain_api.BlockchainAPI.GetBestHeightAndTime:output_type -> blockchain_api.GetBestHeightAndTimeResponse
