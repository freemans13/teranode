...
const (
	...
	BlockValidationAPI_GetBridgeBlockIDs_FullMethodName = "/blockvalidation_api.BlockValidationAPI/GetBridgeBlockIDs"
)
...
type BlockValidationAPIClient interface {
	...
	// Used by subtree validation to check conflict status for recently-mined txs
	// whose SetTxMined DB writes haven't completed yet.
	GetBridgeBlockIDs(ctx context.Context, in *GetBridgeBlockIDsRequest, opts ...grpc.CallOption) (*GetBridgeBlockIDsResponse, error)
}
...
func (c *blockValidationAPIClient) GetBridgeBlockIDs(ctx context.Context, in *GetBridgeBlockIDsRequest, opts ...grpc.CallOption) (*GetBridgeBlockIDsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetBridgeBlockIDsResponse)
	err := c.cc.Invoke(ctx, BlockValidationAPI_GetBridgeBlockIDs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BlockValidationAPIServer interface {
	...
	// Used by subtree validation to check conflict status for recently-mined txs
	// whose SetTxMined DB writes haven't completed yet.
	GetBridgeBlockIDs(context.Context, *GetBridgeBlockIDsRequest) (*GetBridgeBlockIDsResponse, error)
...
func (UnimplementedBlockValidationAPIServer) GetBridgeBlockIDs(context.Context, *GetBridgeBlockIDsRequest) (*GetBridgeBlockIDsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetBridgeBlockIDs not implemented")
}
...
func _BlockValidationAPI_GetBridgeBlockIDs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetBridgeBlockIDsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BlockValidationAPIServer).GetBridgeBlockIDs(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BlockValidationAPI_GetBridgeBlockIDs_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BlockValidationAPIServer).GetBridgeBlockIDs(ctx, req.(*GetBridgeBlockIDsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BlockValidationAPI_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetBridgeBlockIDs",
			Handler:    _BlockValidationAPI_GetBridgeBlockIDs_Handler,
		},
	},
