...
// swagger:model ProcessBlockWindowRequest
type ProcessBlockWindowRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// block[i], height[i], and block_id[i] describe the i-th block in the window.
	// All three repeated arrays must have the same length.
	Block         [][]byte `protobuf:"bytes,1,rep,name=block,proto3" json:"block,omitempty"`
	Height        []uint32 `protobuf:"varint,2,rep,packed,name=height,proto3" json:"height,omitempty"`
	BlockId       []uint32 `protobuf:"varint,3,rep,packed,name=block_id,json=blockId,proto3" json:"block_id,omitempty"` // Pre-assigned block IDs (0 = not pre-assigned)
	PeerId        string   `protobuf:"bytes,4,opt,name=peer_id,json=peerId,proto3" json:"peer_id,omitempty"`            // P2P peer identifier for peer tracking via P2P service
	BaseUrl       string   `protobuf:"bytes,5,opt,name=base_url,json=baseUrl,proto3" json:"base_url,omitempty"`         // Peer base URL; defaults to "legacy" if empty
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ProcessBlockWindowRequest) Reset() {
	*x = ProcessBlockWindowRequest{}
	mi := &file_services_blockvalidation_blockvalidation_api_blockvalidation_api_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ProcessBlockWindowRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProcessBlockWindowRequest) ProtoMessage() {}

func (x *ProcessBlockWindowRequest) ProtoReflect() protoreflect.Message {
	mi := &file_services_blockvalidation_blockvalidation_api_blockvalidation_api_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProcessBlockWindowRequest.ProtoReflect.Descriptor instead.
func (*ProcessBlockWindowRequest) Descriptor() ([]byte, []int) {
	return file_services_blockvalidation_blockvalidation_api_blockvalidation_api_proto_rawDescGZIP(), []int{6}
}

func (x *ProcessBlockWindowRequest) GetBlock() [][]byte {
	if x != nil {
		return x.Block
	}
	return nil
...
func (x *ProcessBlockWindowRequest) GetHeight() []uint32 {
	if x != nil {
		return x.Height
	}
	return nil
...
func (x *ProcessBlockWindowRequest) GetBlockId() []uint32 {
	if x != nil {
		return x.BlockId
	}
	return nil
...
func (x *ProcessBlockWindowRequest) GetPeerId() string {
	if x != nil {
		return x.PeerId
	}
	return ""
...
func (x *ProcessBlockWindowRequest) GetBaseUrl() string {
	if x != nil {
		return x.BaseUrl
	}
	return ""
...
const file_services_blockvalidation_blockvalidation_api_blockvalidation_api_proto_rawDesc = "" +
	...
	"\x19ProcessBlockWindowRequest\x12\x14\n" +
	"\x05block\x18\x01 \x03(\fR\x05block\x12\x16\n" +
	"\x06height\x18\x02 \x03(\rR\x06height\x12\x19\n" +
	"\bblock_id\x18\x03 \x03(\rR\ablockId\x12\x17\n" +
	"\apeer_id\x18\x04 \x01(\tR\x06peerId\x12\x19\n" +
	"\bbase_url\x18\x05 \x01(\tR\abaseUrl\",\n" +
...
var file_services_blockvalidation_blockvalidation_api_blockvalidation_api_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_services_blockvalidation_blockvalidation_api_blockvalidation_api_proto_goTypes = []any{
	...
	(*ProcessBlockWindowRequest)(nil), // 6: blockvalidation_api.ProcessBlockWindowRequest
	(*RevalidateBlockRequest)(nil),    // 7: blockvalidation_api.RevalidateBlockRequest
	(*PreviousCatchupAttempt)(nil),    // 8: blockvalidation_api.PreviousCatchupAttempt
	(*CatchupStatusResponse)(nil),     // 9: blockvalidation_api.CatchupStatusResponse
	(*timestamppb.Timestamp)(nil),     // 10: google.protobuf.Timestamp
}
var file_services_blockvalidation_blockvalidation_api_blockvalidation_api_proto_depIdxs = []int32{
	10, // 0: blockvalidation_api.HealthResponse.timestamp:type_name -> google.protobuf.Timestamp
	8,  // 1: blockvalidation_api.CatchupStatusResponse.previous_attempt:type_name -> blockvalidation_api.PreviousCatchupAttempt
