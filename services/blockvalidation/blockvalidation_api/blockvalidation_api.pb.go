...
// swagger:model GetBridgeBlockIDsRequest
type GetBridgeBlockIDsRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *GetBridgeBlockIDsRequest) Reset() {
	*x = GetBridgeBlockIDsRequest{}
	mi := &file_services_blockvalidation_blockvalidation_api_blockvalidation_api_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetBridgeBlockIDsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetBridgeBlockIDsRequest) ProtoMessage() {}

func (x *GetBridgeBlockIDsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_services_blockvalidation_blockvalidation_api_blockvalidation_api_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetBridgeBlockIDsRequest.ProtoReflect.Descriptor instead.
func (*GetBridgeBlockIDsRequest) Descriptor() ([]byte, []int) {
	return file_services_blockvalidation_blockvalidation_api_blockvalidation_api_proto_rawDescGZIP(), []int{8}
}

func (x *GetBridgeBlockIDsRequest) GetTxHash() []byte {
	if x != nil {
		return x.TxHash
	}
	return nil
...
// swagger:model GetBridgeBlockIDsResponse
type GetBridgeBlockIDsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	BlockIds      []uint32               `protobuf:"varint,1,rep,packed,name=block_ids,json=blockIds,proto3" json:"block_ids,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetBridgeBlockIDsResponse) Reset() {
	*x = GetBridgeBlockIDsResponse{}
	mi := &file_services_blockvalidation_blockvalidation_api_blockvalidation_api_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetBridgeBlockIDsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetBridgeBlockIDsResponse) ProtoMessage() {}

func (x *GetBridgeBlockIDsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_services_blockvalidation_blockvalidation_api_blockvalidation_api_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetBridgeBlockIDsResponse.ProtoReflect.Descriptor instead.
func (*GetBridgeBlockIDsResponse) Descriptor() ([]byte, []int) {
	return file_services_blockvalidation_blockvalidation_api_blockvalidation_api_proto_rawDescGZIP(), []int{9}
}

func (x *GetBridgeBlockIDsResponse) GetBlockIds() []uint32 {
	if x != nil {
		return x.BlockIds
	}
	return nil
...
const file_services_blockvalidation_blockvalidation_api_blockvalidation_api_proto_rawDesc = "" +
	...
	"durationMs\x12)\n" +
	"\x10blocks_validated\x18\t \x01(\x03R\x0fblocksValidated\"3\n" +
	"\x18GetBridgeBlockIDsRequest\x12\x17\n" +
	"\atx_hash\x18\x01 \x01(\fR\x06txHash\"8\n" +
	"\x19GetBridgeBlockIDsResponse\x12\x1b\n" +
	"\tblock_ids\x18\x01 \x03(\rR\bblockIds\"\x88\x05\n" +
	...
	"\x10previous_attempt\x18\x0f \x01(\v2+.blockvalidation_api.PreviousCatchupAttemptR\x0fpreviousAttempt2\xd0\x05\n" +
	...
	"\x10GetCatchupStatus\x12!.blockvalidation_api.EmptyMessage\x1a*.blockvalidation_api.CatchupStatusResponse\"\x00\x12t\n" +
	"\x11GetBridgeBlockIDs\x12-.blockvalidation_api.GetBridgeBlockIDsRequest\x1a..blockvalidation_api.GetBridgeBlockIDsResponse\"\x00B\x18Z\x16./;blockvalidation_apib\x06proto3"
...
var file_services_blockvalidation_blockvalidation_api_blockvalidation_api_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_services_blockvalidation_blockvalidation_api_blockvalidation_api_proto_goTypes = []any{
	...
	(*GetBridgeBlockIDsRequest)(nil),  // 8: blockvalidation_api.GetBridgeBlockIDsRequest
	(*GetBridgeBlockIDsResponse)(nil), // 9: blockvalidation_api.GetBridgeBlockIDsResponse
	(*CatchupStatusResponse)(nil),     // 10: blockvalidation_api.CatchupStatusResponse
	(*timestamppb.Timestamp)(nil),     // 11: google.protobuf.Timestamp
}
var file_services_blockvalidation_blockvalidation_api_blockvalidation_api_proto_depIdxs = []int32{
	11, // 0: blockvalidation_api.HealthResponse.timestamp:type_name -> google.protobuf.Timestamp
	...
	8,  // 8: blockvalidation_api.BlockValidationAPI.GetBridgeBlockIDs:input_type -> blockvalidation_api.GetBridgeBlockIDsRequest
	...
	5,  // 12: blockvalidation_api.BlockValidationAPI.ValidateBlock:output_type -> blockvalidation_api.ValidateBlockResponse
	0,  // 13: blockvalidation_api.BlockValidationAPI.RevalidateBlock:output_type -> blockvalidation_api.EmptyMessage
	10, // 14: blockvalidation_api.BlockValidationAPI.GetCatchupStatus:output_type -> blockvalidation_api.CatchupStatusResponse
	9,  // 15: blockvalidation_api.BlockValidationAPI.GetBridgeBlockIDs:output_type -> blockvalidation_api.GetBridgeBlockIDsResponse
