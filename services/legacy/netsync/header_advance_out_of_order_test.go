...
func buildHeaderRound(t *testing.T, n int) (*SyncManager, []chainhash.Hash) {
	...
	// handleHeadersMsg used to call this itself once the checkpoint branch
	// trimmed the anchor; it is what publishes the frontier the tests below
	// read off sm.frontierHashForTest().
