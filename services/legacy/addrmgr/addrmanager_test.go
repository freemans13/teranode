...
// naTests houses all the tests to be performed against the NetAddressKey
// method.
...
func TestAddAddressByIP(t *testing.T) {
	...
	amgr := addrmgr.New(ulogger.TestLogger{}, "testaddressbyip", nil)
...
func TestAttempt(t *testing.T) {
	n := addrmgr.New(ulogger.TestLogger{}, "testattempt", lookupFunc)
...
func TestConnected(t *testing.T) {
	n := addrmgr.New(ulogger.TestLogger{}, "testconnected", lookupFunc)
...
func TestGood(t *testing.T) {
	n := addrmgr.New(ulogger.TestLogger{}, "testgood", lookupFunc)
	addrsToAdd := 64 * 64
	addrs := make([]*wire.NetAddress, addrsToAdd)
...
func TestGetAddress(t *testing.T) {
	n := addrmgr.New(ulogger.TestLogger{}, "testgetaddress", lookupFunc)
...
func TestGetBestLocalAddress(t *testing.T) {
	...
	amgr := addrmgr.New(ulogger.TestLogger{}, "testgetbestlocaladdress", nil)
