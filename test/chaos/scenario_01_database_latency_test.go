...
func TestScenario01_DatabaseLatency(t *testing.T) {
	...
	const (
		...
		proxyName         = "postgres"
		dbConnStr         = "postgres://postgres:really_strong_password_change_me@localhost:5432/postgres?sslmode=disable"                     //nolint:gosec // G101 - test credentials, not real
		toxiproxyConnStr  = "postgres://postgres:really_strong_password_change_me@localhost:15432/postgres?sslmode=disable&connect_timeout=30" //nolint:gosec // G101 - test credentials, not real
