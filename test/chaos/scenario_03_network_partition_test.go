...
func TestScenario03_NetworkPartition(t *testing.T) {
	...
	const (
		...
		kafkaProxy        = "kafka"
		postgresDirectURL = "postgres://postgres:really_strong_password_change_me@localhost:5432/postgres?sslmode=disable"                    //nolint:gosec // G101 - test credentials, not real
		postgresToxiConn  = "postgres://postgres:really_strong_password_change_me@localhost:15432/postgres?sslmode=disable&connect_timeout=5" //nolint:gosec // G101 - test credentials, not real
